...
public class GenericsAndTernary {
    ...
    public static void main(String[] args) {
        ...
        var box = new MyBox<Integer>(5); // 'var' infers the type from teh right-hand side
        ...
        // Can't do dynamic typing (you can in python); i.e. box.setVal("Hello")
        ...
        for (int i = 0; i < 1000000; i++) {
            if (i % 2 != 0) continue; // Skips the rest of the code and starts loop at next iteration
            System.out.println(i);
            if (i == 10) break; // Breaks out of hte loop entirely (like return)
        }
        ...
        switch(today) {
            ...
            default -> System.out.println("It is not Wednesday my dudes");
        }
    }
}
